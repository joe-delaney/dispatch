        ...
        <div className="welcome-nav-bar logged-in">
            <div className="welcome-nav-bar-left-section">
                ...
                <ul className="personal-links">
                    ...
                    <a className="welcome-nav-bar-heading-logged-in" href="#">LinkedIn</a>
                    <a className="welcome-nav-bar-heading-logged-in" href="#">Github</a>
                </ul>
            </div>
        ...
        <div className="welcome-nav-bar logged-out">
            <div className="welcome-nav-bar-left-section">
                ...
                <ul className="personal-links">
                    ...
                    <a className="welcome-nav-bar-heading-logged-out" href="#">LinkedIn</a>
                    <a className="welcome-nav-bar-heading-logged-out" href="#">Github</a>
                </ul>
            </div>
            <div className="welcome-nav-bar-buttons">
